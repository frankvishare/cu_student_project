set moduleName conv_fprop_Pipeline_1
set isTopModule 0
...
set cdfgNum 6
set C_modelName {conv_fprop_Pipeline_1}
...
set C_modelArgList {
	{ layer_map_common int 64 regular {array 1024 { 0 3 } 0 1 }  }
	{ size int 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer_map_common", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ layer_map_common_address0 sc_out sc_lv 10 signal 0 } 
	{ layer_map_common_ce0 sc_out sc_logic 1 signal 0 } 
	{ layer_map_common_we0 sc_out sc_logic 1 signal 0 } 
	{ layer_map_common_d0 sc_out sc_lv 64 signal 0 } 
...
set Spec2ImplPortList { 
	layer_map_common { ap_memory {  { layer_map_common_address0 mem_address 1 10 }  { layer_map_common_ce0 mem_ce 1 1 }  { layer_map_common_we0 mem_we 1 1 }  { layer_map_common_d0 mem_din 1 64 } } }
