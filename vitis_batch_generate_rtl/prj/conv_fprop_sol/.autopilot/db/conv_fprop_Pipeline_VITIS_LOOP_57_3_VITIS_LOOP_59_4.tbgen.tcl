set moduleName conv_fprop_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4
set isTopModule 0
...
set cdfgNum 6
set C_modelName {conv_fprop_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4}
...
set C_modelArgMapList {[ 
	{ "Name" : "layer_kernel_w_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln52", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln61_1", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "prev_layer_map_data", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "layer_kernel_load", "interface" : "wire", "bitwidth" : 3200, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer_kernel_w_load sc_in sc_lv 32 signal 0 } 
	{ mul_ln101 sc_in sc_lv 62 signal 1 } 
	{ empty_11 sc_in sc_lv 17 signal 2 } 
	{ empty_12 sc_in sc_lv 17 signal 3 } 
	{ sext_ln52 sc_in sc_lv 32 signal 4 } 
	{ empty sc_in sc_lv 17 signal 5 } 
	{ zext_ln61_1 sc_in sc_lv 17 signal 6 } 
	{ prev_layer_map_data_address0 sc_out sc_lv 17 signal 7 } 
	{ prev_layer_map_data_ce0 sc_out sc_logic 1 signal 7 } 
	{ prev_layer_map_data_q0 sc_in sc_lv 64 signal 7 } 
	{ layer_kernel_load sc_in sc_lv 3200 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer_kernel_w_load", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer_kernel_w_load", "role": "default" }} , 
 	...
 	{ "name": "sext_ln52", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln52", "role": "default" }} , 
 	{ "name": "empty", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "empty", "role": "default" }} , 
 	{ "name": "zext_ln61_1", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "zext_ln61_1", "role": "default" }} , 
 	...
 	{ "name": "layer_kernel_load", "direction": "in", "datatype": "sc_lv", "bitwidth":3200, "type": "signal", "bundle":{"name": "layer_kernel_load", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	layer_kernel_load { ap_none {  { layer_kernel_load in_data 0 3200 } } }
