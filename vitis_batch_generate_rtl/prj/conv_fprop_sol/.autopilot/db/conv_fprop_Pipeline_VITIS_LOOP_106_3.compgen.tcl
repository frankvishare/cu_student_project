...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer_map_common_address0 { O 10 vector } layer_map_common_ce0 { O 1 bit } layer_map_common_q0 { I 64 vector } } \
} "
} else {
