; ModuleID = '/home/duludulu/Documents/hls/vitis_batch_generate_rtl/prj/conv_fprop_sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_conv_fprop_ir(%struct._Layer* noalias nocapture nonnull readonly %prev_layer, %struct._Layer* noalias nocapture nonnull %layer, i1* noalias nonnull readonly "fpga.decayed.dim.hint"="96" %pconnection) local_unnamed_addr #0 {
entry:
  %.01 = call i8* @malloc(i64 4)
  %prev_layer_copy.0 = bitcast i8* %.01 to i32*
  %.12 = call i8* @malloc(i64 4)
  %prev_layer_copy.1 = bitcast i8* %.12 to i32*
  %.23 = call i8* @malloc(i64 4)
  %prev_layer_copy.2 = bitcast i8* %.23 to i32*
  %.3.09 = call i8* @malloc(i64 983040)
  %prev_layer_copy.3.0 = bitcast i8* %.3.09 to [120 x [1024 x double]]*
  %.3.110 = call i8* @malloc(i64 983040)
  %prev_layer_copy.3.1 = bitcast i8* %.3.110 to [120 x [1024 x double]]*
  %.3.211 = call i8* @malloc(i64 960)
  %prev_layer_copy.3.2 = bitcast i8* %.3.211 to [120 x double]*
  %.3.312 = call i8* @malloc(i64 960)
  %prev_layer_copy.3.3 = bitcast i8* %.3.312 to [120 x double]*
  %.44 = call i8* @malloc(i64 4)
  %prev_layer_copy.4 = bitcast i8* %.44 to i32*
  %.55 = call i8* @malloc(i64 4)
  %prev_layer_copy.5 = bitcast i8* %.55 to i32*
  %.66 = call i8* @malloc(i64 4)
  %prev_layer_copy.6 = bitcast i8* %.66 to i32*
  %.77 = call i8* @malloc(i64 983040)
  %prev_layer_copy.7 = bitcast i8* %.77 to [1920 x i3200]*
  %.88 = call i8* @malloc(i64 8192)
  %prev_layer_copy.8 = bitcast i8* %.88 to [1024 x double]*
  %.0 = call i8* @malloc(i64 4)
  %layer_copy.0 = bitcast i8* %.0 to i32*
  %.1 = call i8* @malloc(i64 4)
  %layer_copy.1 = bitcast i8* %.1 to i32*
  %.2 = call i8* @malloc(i64 4)
  %layer_copy.2 = bitcast i8* %.2 to i32*
  %.3.0 = call i8* @malloc(i64 983040)
  %layer_copy.3.0 = bitcast i8* %.3.0 to [120 x [1024 x double]]*
  %.3.1 = call i8* @malloc(i64 983040)
  %layer_copy.3.1 = bitcast i8* %.3.1 to [120 x [1024 x double]]*
  %.3.2 = call i8* @malloc(i64 960)
  %layer_copy.3.2 = bitcast i8* %.3.2 to [120 x double]*
  %.3.3 = call i8* @malloc(i64 960)
  %layer_copy.3.3 = bitcast i8* %.3.3 to [120 x double]*
  %.4 = call i8* @malloc(i64 4)
  %layer_copy.4 = bitcast i8* %.4 to i32*
  %.5 = call i8* @malloc(i64 4)
  %layer_copy.5 = bitcast i8* %.5 to i32*
  %.6 = call i8* @malloc(i64 4)
  %layer_copy.6 = bitcast i8* %.6 to i32*
  %.7 = call i8* @malloc(i64 983040)
  %layer_copy.7 = bitcast i8* %.7 to [1920 x i3200]*
  %.8 = call i8* @malloc(i64 8192)
  %layer_copy.8 = bitcast i8* %.8 to [1024 x double]*
  %0 = bitcast i1* %pconnection to [96 x i1]*
  %pconnection_copy = alloca [96 x i1], align 512
  call fastcc void @copy_in(%struct._Layer* nonnull %prev_layer, i32* %prev_layer_copy.0, i32* %prev_layer_copy.1, i32* %prev_layer_copy.2, [120 x [1024 x double]]* %prev_layer_copy.3.0, [120 x [1024 x double]]* %prev_layer_copy.3.1, [120 x double]* %prev_layer_copy.3.2, [120 x double]* %prev_layer_copy.3.3, i32* %prev_layer_copy.4, i32* %prev_layer_copy.5, i32* %prev_layer_copy.6, [1920 x i3200]* %prev_layer_copy.7, [1024 x double]* %prev_layer_copy.8, %struct._Layer* nonnull %layer, i32* %layer_copy.0, i32* %layer_copy.1, i32* %layer_copy.2, [120 x [1024 x double]]* %layer_copy.3.0, [120 x [1024 x double]]* %layer_copy.3.1, [120 x double]* %layer_copy.3.2, [120 x double]* %layer_copy.3.3, i32* %layer_copy.4, i32* %layer_copy.5, i32* %layer_copy.6, [1920 x i3200]* %layer_copy.7, [1024 x double]* %layer_copy.8, [96 x i1]* nonnull %0, [96 x i1]* nonnull align 512 %pconnection_copy)
  call void @apatb_conv_fprop_hw(i32* %prev_layer_copy.0, i32* %prev_layer_copy.1, i32* %prev_layer_copy.2, [120 x [1024 x double]]* %prev_layer_copy.3.0, [120 x [1024 x double]]* %prev_layer_copy.3.1, [120 x double]* %prev_layer_copy.3.2, [120 x double]* %prev_layer_copy.3.3, i32* %prev_layer_copy.4, i32* %prev_layer_copy.5, i32* %prev_layer_copy.6, [1920 x i3200]* %prev_layer_copy.7, [1024 x double]* %prev_layer_copy.8, i32* %layer_copy.0, i32* %layer_copy.1, i32* %layer_copy.2, [120 x [1024 x double]]* %layer_copy.3.0, [120 x [1024 x double]]* %layer_copy.3.1, [120 x double]* %layer_copy.3.2, [120 x double]* %layer_copy.3.3, i32* %layer_copy.4, i32* %layer_copy.5, i32* %layer_copy.6, [1920 x i3200]* %layer_copy.7, [1024 x double]* %layer_copy.8, [96 x i1]* %pconnection_copy)
  call void @copy_back(%struct._Layer* %prev_layer, i32* %prev_layer_copy.0, i32* %prev_layer_copy.1, i32* %prev_layer_copy.2, [120 x [1024 x double]]* %prev_layer_copy.3.0, [120 x [1024 x double]]* %prev_layer_copy.3.1, [120 x double]* %prev_layer_copy.3.2, [120 x double]* %prev_layer_copy.3.3, i32* %prev_layer_copy.4, i32* %prev_layer_copy.5, i32* %prev_layer_copy.6, [1920 x i3200]* %prev_layer_copy.7, [1024 x double]* %prev_layer_copy.8, %struct._Layer* %layer, i32* %layer_copy.0, i32* %layer_copy.1, i32* %layer_copy.2, [120 x [1024 x double]]* %layer_copy.3.0, [120 x [1024 x double]]* %layer_copy.3.1, [120 x double]* %layer_copy.3.2, [120 x double]* %layer_copy.3.3, i32* %layer_copy.4, i32* %layer_copy.5, i32* %layer_copy.6, [1920 x i3200]* %layer_copy.7, [1024 x double]* %layer_copy.8, [96 x i1]* %0, [96 x i1]* %pconnection_copy)
...
declare void @apatb_conv_fprop_hw(i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*, [96 x i1]*)
...
declare void @conv_fprop_hw_stub(%struct._Layer* noalias nocapture nonnull readonly, %struct._Layer* noalias nocapture nonnull, i1* noalias nonnull readonly)

define void @conv_fprop_hw_stub_wrapper(i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*, [96 x i1]*) #6 {
entry:
  %25 = call i8* @malloc(i64 2744224)
  %26 = bitcast i8* %25 to %struct._Layer*
  %27 = call i8* @malloc(i64 2744224)
  %28 = bitcast i8* %27 to %struct._Layer*
  call void @copy_out(%struct._Layer* %26, i32* %0, i32* %1, i32* %2, [120 x [1024 x double]]* %3, [120 x [1024 x double]]* %4, [120 x double]* %5, [120 x double]* %6, i32* %7, i32* %8, i32* %9, [1920 x i3200]* %10, [1024 x double]* %11, %struct._Layer* %28, i32* %12, i32* %13, i32* %14, [120 x [1024 x double]]* %15, [120 x [1024 x double]]* %16, [120 x double]* %17, [120 x double]* %18, i32* %19, i32* %20, i32* %21, [1920 x i3200]* %22, [1024 x double]* %23, [96 x i1]* null, [96 x i1]* %24)
  %29 = bitcast [96 x i1]* %24 to i1*
  call void @conv_fprop_hw_stub(%struct._Layer* %26, %struct._Layer* %28, i1* %29)
  call void @copy_in(%struct._Layer* %26, i32* %0, i32* %1, i32* %2, [120 x [1024 x double]]* %3, [120 x [1024 x double]]* %4, [120 x double]* %5, [120 x double]* %6, i32* %7, i32* %8, i32* %9, [1920 x i3200]* %10, [1024 x double]* %11, %struct._Layer* %28, i32* %12, i32* %13, i32* %14, [120 x [1024 x double]]* %15, [120 x [1024 x double]]* %16, [120 x double]* %17, [120 x double]* %18, i32* %19, i32* %20, i32* %21, [1920 x i3200]* %22, [1024 x double]* %23, [96 x i1]* null, [96 x i1]* %24)
