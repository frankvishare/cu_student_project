...
entity conv_fprop_conv_fprop_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conv_fprop_conv_fprop_Pipeline_1 is 
...
begin
    ...
    layer_map_common_address0 <= p_cast13_fu_64_p1(10 - 1 downto 0);
    layer_map_common_ce0 <= layer_map_common_ce0_local;

    layer_map_common_ce0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce)
    begin
    ...
    layer_map_common_d0 <= ap_const_lv64_0;
    layer_map_common_we0 <= layer_map_common_we0_local;

    layer_map_common_we0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
