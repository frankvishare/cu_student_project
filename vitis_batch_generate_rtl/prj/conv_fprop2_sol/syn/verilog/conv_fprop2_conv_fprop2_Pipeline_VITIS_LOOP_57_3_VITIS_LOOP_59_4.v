...
module conv_fprop2_conv_fprop2_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input   ap_ce;
input  [31:0] c3_conv_layer1_kernel_w_load;
input  [61:0] mul_ln139;
input  [16:0] empty_11;
input  [16:0] empty_12;
input  [15:0] empty_13;
input  [16:0] empty;
...
reg   [63:0] s2_pooling_layer2_data_load_reg_446;
reg   [63:0] c3_conv_layer2_W_load_reg_456;
...
reg    c3_conv_layer2_W_ce0_local;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        c3_conv_layer2_W_ce0_local = 1'b1;
    end else begin
        c3_conv_layer2_W_ce0_local = 1'b0;
    end
end
...
assign c3_conv_layer2_W_address0 = zext_ln61_1_fu_290_p1;

assign c3_conv_layer2_W_ce0 = c3_conv_layer2_W_ce0_local;

assign grp_fu_163_p0 = s2_pooling_layer2_data_load_reg_446;

assign grp_fu_163_p1 = c3_conv_layer2_W_load_reg_456;
...
assign icmp_ln57_fu_202_p2 = ((indvar_flatten_fu_74 == mul_ln139) ? 1'b1 : 1'b0);

assign icmp_ln59_fu_197_p2 = (($signed(zext_ln59_fu_193_p1) < $signed(c3_conv_layer1_kernel_w_load)) ? 1'b1 : 1'b0);

assign s2_pooling_layer2_data_address0 = zext_ln61_fu_282_p1;
...
endmodule //conv_fprop2_conv_fprop2_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4
