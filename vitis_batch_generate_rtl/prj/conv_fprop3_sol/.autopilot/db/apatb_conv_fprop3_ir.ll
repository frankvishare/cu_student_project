...
define void @apatb_conv_fprop3_ir(i8 zeroext %ap_core, i8 zeroext %ap_part, i8 zeroext %ap_parent, %struct._Layer1* noalias nocapture nonnull readonly %s4_pooling_layer1, %struct._Layer2* noalias nocapture nonnull readonly %s4_pooling_layer2, %struct._Layer1* noalias nocapture nonnull readonly %c5_conv_layer1, %struct._Layer2* noalias nocapture nonnull %c5_conv_layer2, i1* noalias nonnull readonly "fpga.decayed.dim.hint"="96" %pconnection) local_unnamed_addr #0 {
entry:
  ...
  %s4_pooling_layer2_copy.0 = bitcast i8* %.0 to [120 x [1024 x double]]*
  %.1 = call i8* @malloc(i64 983040)
  %s4_pooling_layer2_copy.1 = bitcast i8* %.1 to [120 x [1024 x double]]*
  %.2 = call i8* @malloc(i64 960)
  %s4_pooling_layer2_copy.2 = bitcast i8* %.2 to [120 x double]*
  %.3 = call i8* @malloc(i64 960)
  %s4_pooling_layer2_copy.3 = bitcast i8* %.3 to [120 x double]*
  %.4 = call i8* @malloc(i64 384000)
  %s4_pooling_layer2_copy.4 = bitcast i8* %.4 to [1920 x [25 x double]]*
  %.5 = call i8* @malloc(i64 384000)
  %s4_pooling_layer2_copy.5 = bitcast i8* %.5 to [1920 x [25 x double]]*
  %.6 = call i8* @malloc(i64 8192)
  %s4_pooling_layer2_copy.6 = bitcast i8* %.6 to [1024 x double]*
  %c5_conv_layer1_copy.0 = alloca i32, align 512
  %c5_conv_layer1_copy.1 = alloca i32, align 512
  %c5_conv_layer1_copy.2 = alloca i32, align 512
  %c5_conv_layer1_copy.3 = alloca i32, align 512
  %c5_conv_layer1_copy.4 = alloca i32, align 512
  %c5_conv_layer1_copy.5 = alloca i32, align 512
  %.01 = call i8* @malloc(i64 983040)
  %c5_conv_layer2_copy.0 = bitcast i8* %.01 to [120 x [1024 x double]]*
  %.12 = call i8* @malloc(i64 983040)
  %c5_conv_layer2_copy.1 = bitcast i8* %.12 to [120 x [1024 x double]]*
  %.23 = call i8* @malloc(i64 960)
  %c5_conv_layer2_copy.2 = bitcast i8* %.23 to [120 x double]*
  %.34 = call i8* @malloc(i64 960)
  %c5_conv_layer2_copy.3 = bitcast i8* %.34 to [120 x double]*
  %.45 = call i8* @malloc(i64 384000)
  %c5_conv_layer2_copy.4 = bitcast i8* %.45 to [1920 x [25 x double]]*
  %.56 = call i8* @malloc(i64 384000)
  %c5_conv_layer2_copy.5 = bitcast i8* %.56 to [1920 x [25 x double]]*
  %.67 = call i8* @malloc(i64 8192)
  %c5_conv_layer2_copy.6 = bitcast i8* %.67 to [1024 x double]*
  %0 = bitcast i1* %pconnection to [96 x i1]*
  %pconnection_copy = alloca [96 x i1], align 512
  call fastcc void @copy_in(%struct._Layer1* nonnull %s4_pooling_layer1, i32* nonnull align 512 %s4_pooling_layer1_copy.0, i32* nonnull align 512 %s4_pooling_layer1_copy.1, i32* nonnull align 512 %s4_pooling_layer1_copy.2, i32* nonnull align 512 %s4_pooling_layer1_copy.3, i32* nonnull align 512 %s4_pooling_layer1_copy.4, i32* nonnull align 512 %s4_pooling_layer1_copy.5, %struct._Layer2* nonnull %s4_pooling_layer2, [120 x [1024 x double]]* %s4_pooling_layer2_copy.0, [120 x [1024 x double]]* %s4_pooling_layer2_copy.1, [120 x double]* %s4_pooling_layer2_copy.2, [120 x double]* %s4_pooling_layer2_copy.3, [1920 x [25 x double]]* %s4_pooling_layer2_copy.4, [1920 x [25 x double]]* %s4_pooling_layer2_copy.5, [1024 x double]* %s4_pooling_layer2_copy.6, %struct._Layer1* nonnull %c5_conv_layer1, i32* nonnull align 512 %c5_conv_layer1_copy.0, i32* nonnull align 512 %c5_conv_layer1_copy.1, i32* nonnull align 512 %c5_conv_layer1_copy.2, i32* nonnull align 512 %c5_conv_layer1_copy.3, i32* nonnull align 512 %c5_conv_layer1_copy.4, i32* nonnull align 512 %c5_conv_layer1_copy.5, %struct._Layer2* nonnull %c5_conv_layer2, [120 x [1024 x double]]* %c5_conv_layer2_copy.0, [120 x [1024 x double]]* %c5_conv_layer2_copy.1, [120 x double]* %c5_conv_layer2_copy.2, [120 x double]* %c5_conv_layer2_copy.3, [1920 x [25 x double]]* %c5_conv_layer2_copy.4, [1920 x [25 x double]]* %c5_conv_layer2_copy.5, [1024 x double]* %c5_conv_layer2_copy.6, [96 x i1]* nonnull %0, [96 x i1]* nonnull align 512 %pconnection_copy)
  call void @apatb_conv_fprop3_hw(i8 %ap_core, i8 %ap_part, i8 %ap_parent, i32* %s4_pooling_layer1_copy.0, i32* %s4_pooling_layer1_copy.1, i32* %s4_pooling_layer1_copy.2, i32* %s4_pooling_layer1_copy.3, i32* %s4_pooling_layer1_copy.4, i32* %s4_pooling_layer1_copy.5, [120 x [1024 x double]]* %s4_pooling_layer2_copy.0, [120 x [1024 x double]]* %s4_pooling_layer2_copy.1, [120 x double]* %s4_pooling_layer2_copy.2, [120 x double]* %s4_pooling_layer2_copy.3, [1920 x [25 x double]]* %s4_pooling_layer2_copy.4, [1920 x [25 x double]]* %s4_pooling_layer2_copy.5, [1024 x double]* %s4_pooling_layer2_copy.6, i32* %c5_conv_layer1_copy.0, i32* %c5_conv_layer1_copy.1, i32* %c5_conv_layer1_copy.2, i32* %c5_conv_layer1_copy.3, i32* %c5_conv_layer1_copy.4, i32* %c5_conv_layer1_copy.5, [120 x [1024 x double]]* %c5_conv_layer2_copy.0, [120 x [1024 x double]]* %c5_conv_layer2_copy.1, [120 x double]* %c5_conv_layer2_copy.2, [120 x double]* %c5_conv_layer2_copy.3, [1920 x [25 x double]]* %c5_conv_layer2_copy.4, [1920 x [25 x double]]* %c5_conv_layer2_copy.5, [1024 x double]* %c5_conv_layer2_copy.6, [96 x i1]* %pconnection_copy)
  call void @copy_back(%struct._Layer1* %s4_pooling_layer1, i32* %s4_pooling_layer1_copy.0, i32* %s4_pooling_layer1_copy.1, i32* %s4_pooling_layer1_copy.2, i32* %s4_pooling_layer1_copy.3, i32* %s4_pooling_layer1_copy.4, i32* %s4_pooling_layer1_copy.5, %struct._Layer2* %s4_pooling_layer2, [120 x [1024 x double]]* %s4_pooling_layer2_copy.0, [120 x [1024 x double]]* %s4_pooling_layer2_copy.1, [120 x double]* %s4_pooling_layer2_copy.2, [120 x double]* %s4_pooling_layer2_copy.3, [1920 x [25 x double]]* %s4_pooling_layer2_copy.4, [1920 x [25 x double]]* %s4_pooling_layer2_copy.5, [1024 x double]* %s4_pooling_layer2_copy.6, %struct._Layer1* %c5_conv_layer1, i32* %c5_conv_layer1_copy.0, i32* %c5_conv_layer1_copy.1, i32* %c5_conv_layer1_copy.2, i32* %c5_conv_layer1_copy.3, i32* %c5_conv_layer1_copy.4, i32* %c5_conv_layer1_copy.5, %struct._Layer2* %c5_conv_layer2, [120 x [1024 x double]]* %c5_conv_layer2_copy.0, [120 x [1024 x double]]* %c5_conv_layer2_copy.1, [120 x double]* %c5_conv_layer2_copy.2, [120 x double]* %c5_conv_layer2_copy.3, [1920 x [25 x double]]* %c5_conv_layer2_copy.4, [1920 x [25 x double]]* %c5_conv_layer2_copy.5, [1024 x double]* %c5_conv_layer2_copy.6, [96 x i1]* %0, [96 x i1]* %pconnection_copy)
  call void @free(i8* %.0)
  call void @free(i8* %.1)
  call void @free(i8* %.2)
  call void @free(i8* %.3)
...
declare void @apatb_conv_fprop3_hw(i8, i8, i8, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*, [96 x i1]*)
...
declare void @conv_fprop3_hw_stub(i8 zeroext, i8 zeroext, i8 zeroext, %struct._Layer1* noalias nocapture nonnull readonly, %struct._Layer2* noalias nocapture nonnull readonly, %struct._Layer1* noalias nocapture nonnull readonly, %struct._Layer2* noalias nocapture nonnull, i1* noalias nonnull readonly)

define void @conv_fprop3_hw_stub_wrapper(i8, i8, i8, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*, [96 x i1]*) #5 {
entry:
  ...
  call void @conv_fprop3_hw_stub(i8 %0, i8 %1, i8 %2, %struct._Layer1* %31, %struct._Layer2* %33, %struct._Layer1* %35, %struct._Layer2* %37, i1* %38)
