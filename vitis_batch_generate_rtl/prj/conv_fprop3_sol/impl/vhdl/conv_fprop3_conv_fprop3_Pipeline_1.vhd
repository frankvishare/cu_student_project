...
entity conv_fprop3_conv_fprop3_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conv_fprop3_conv_fprop3_Pipeline_1 is 
...
begin
    ...
    empty_fu_32_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    ap_condition_55_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce)
    begin
                ap_condition_55 <= ((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce, exitcond_fu_79_p2)
    begin
        if ((not(((ap_const_logic_0 = ap_ce) or (ap_const_boolean_1 = ap_block_state1_pp0_stage0_iter0))) and (exitcond_fu_79_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_sig_allocacmp_p_load_assign_proc : process(ap_CS_fsm_state1, empty_fu_32, ap_loop_init)
    begin
    ...
    c5_conv_layer_map_common_address0 <= p_cast13_fu_64_p1(10 - 1 downto 0);
    c5_conv_layer_map_common_ce0 <= c5_conv_layer_map_common_ce0_local;

    c5_conv_layer_map_common_ce0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce)
    begin
    ...
    c5_conv_layer_map_common_we0 <= c5_conv_layer_map_common_we0_local;

    c5_conv_layer_map_common_we0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
