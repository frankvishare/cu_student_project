set moduleName max_pooling_fprop2_Pipeline_VITIS_LOOP_268_4
set isTopModule 0
...
set cdfgNum 4
set C_modelName {max_pooling_fprop2_Pipeline_VITIS_LOOP_268_4}
...
set C_modelArgList {
	...
	{ sext_ln265 int 32 regular  }
	{ empty_7 int 17 regular  }
	{ empty int 17 regular  }
	{ zext_ln267 int 17 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv19_cast", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln265", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "empty_7", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln267", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln265 sc_in sc_lv 32 signal 2 } 
	{ empty_7 sc_in sc_lv 17 signal 3 } 
	{ empty sc_in sc_lv 17 signal 4 } 
	{ zext_ln267 sc_in sc_lv 17 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln265", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln265", "role": "default" }} , 
 	...
 	{ "name": "zext_ln267", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "zext_ln267", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln265 { ap_none {  { sext_ln265 in_data 0 32 } } }
	empty_7 { ap_none {  { empty_7 in_data 0 17 } } }
	empty { ap_none {  { empty in_data 0 17 } } }
	zext_ln267 { ap_none {  { zext_ln267 in_data 0 17 } } }
