...
define void @apatb_max_pooling_fprop2_ir(i8 zeroext %ap_core, i8 zeroext %ap_part, i8 zeroext %ap_parent, %struct._Layer* noalias nocapture nonnull readonly %c3_conv_layer, %struct._Layer* noalias nocapture nonnull %s4_pooling_layer) local_unnamed_addr #0 {
entry:
  %.01 = call i8* @malloc(i64 4)
  %c3_conv_layer_copy.0 = bitcast i8* %.01 to i32*
  %.12 = call i8* @malloc(i64 4)
  %c3_conv_layer_copy.1 = bitcast i8* %.12 to i32*
  %.23 = call i8* @malloc(i64 4)
  %c3_conv_layer_copy.2 = bitcast i8* %.23 to i32*
  %.3.09 = call i8* @malloc(i64 983040)
  %c3_conv_layer_copy.3.0 = bitcast i8* %.3.09 to [120 x [1024 x double]]*
  %.3.110 = call i8* @malloc(i64 983040)
  %c3_conv_layer_copy.3.1 = bitcast i8* %.3.110 to [120 x [1024 x double]]*
  %.3.211 = call i8* @malloc(i64 960)
  %c3_conv_layer_copy.3.2 = bitcast i8* %.3.211 to [120 x double]*
  %.3.312 = call i8* @malloc(i64 960)
  %c3_conv_layer_copy.3.3 = bitcast i8* %.3.312 to [120 x double]*
  %.44 = call i8* @malloc(i64 4)
  %c3_conv_layer_copy.4 = bitcast i8* %.44 to i32*
  %.55 = call i8* @malloc(i64 4)
  %c3_conv_layer_copy.5 = bitcast i8* %.55 to i32*
  %.66 = call i8* @malloc(i64 4)
  %c3_conv_layer_copy.6 = bitcast i8* %.66 to i32*
  %.77 = call i8* @malloc(i64 983040)
  %c3_conv_layer_copy.7 = bitcast i8* %.77 to [1920 x i3200]*
  %.88 = call i8* @malloc(i64 8192)
  %c3_conv_layer_copy.8 = bitcast i8* %.88 to [1024 x double]*
  %.0 = call i8* @malloc(i64 4)
  %s4_pooling_layer_copy.0 = bitcast i8* %.0 to i32*
  %.1 = call i8* @malloc(i64 4)
  %s4_pooling_layer_copy.1 = bitcast i8* %.1 to i32*
  %.2 = call i8* @malloc(i64 4)
  %s4_pooling_layer_copy.2 = bitcast i8* %.2 to i32*
  %.3.0 = call i8* @malloc(i64 983040)
  %s4_pooling_layer_copy.3.0 = bitcast i8* %.3.0 to [120 x [1024 x double]]*
  %.3.1 = call i8* @malloc(i64 983040)
  %s4_pooling_layer_copy.3.1 = bitcast i8* %.3.1 to [120 x [1024 x double]]*
  %.3.2 = call i8* @malloc(i64 960)
  %s4_pooling_layer_copy.3.2 = bitcast i8* %.3.2 to [120 x double]*
  %.3.3 = call i8* @malloc(i64 960)
  %s4_pooling_layer_copy.3.3 = bitcast i8* %.3.3 to [120 x double]*
  %.4 = call i8* @malloc(i64 4)
  %s4_pooling_layer_copy.4 = bitcast i8* %.4 to i32*
  %.5 = call i8* @malloc(i64 4)
  %s4_pooling_layer_copy.5 = bitcast i8* %.5 to i32*
  %.6 = call i8* @malloc(i64 4)
  %s4_pooling_layer_copy.6 = bitcast i8* %.6 to i32*
  %.7 = call i8* @malloc(i64 983040)
  %s4_pooling_layer_copy.7 = bitcast i8* %.7 to [1920 x i3200]*
  %.8 = call i8* @malloc(i64 8192)
  %s4_pooling_layer_copy.8 = bitcast i8* %.8 to [1024 x double]*
  call fastcc void @copy_in(%struct._Layer* nonnull %c3_conv_layer, i32* %c3_conv_layer_copy.0, i32* %c3_conv_layer_copy.1, i32* %c3_conv_layer_copy.2, [120 x [1024 x double]]* %c3_conv_layer_copy.3.0, [120 x [1024 x double]]* %c3_conv_layer_copy.3.1, [120 x double]* %c3_conv_layer_copy.3.2, [120 x double]* %c3_conv_layer_copy.3.3, i32* %c3_conv_layer_copy.4, i32* %c3_conv_layer_copy.5, i32* %c3_conv_layer_copy.6, [1920 x i3200]* %c3_conv_layer_copy.7, [1024 x double]* %c3_conv_layer_copy.8, %struct._Layer* nonnull %s4_pooling_layer, i32* %s4_pooling_layer_copy.0, i32* %s4_pooling_layer_copy.1, i32* %s4_pooling_layer_copy.2, [120 x [1024 x double]]* %s4_pooling_layer_copy.3.0, [120 x [1024 x double]]* %s4_pooling_layer_copy.3.1, [120 x double]* %s4_pooling_layer_copy.3.2, [120 x double]* %s4_pooling_layer_copy.3.3, i32* %s4_pooling_layer_copy.4, i32* %s4_pooling_layer_copy.5, i32* %s4_pooling_layer_copy.6, [1920 x i3200]* %s4_pooling_layer_copy.7, [1024 x double]* %s4_pooling_layer_copy.8)
  call void @apatb_max_pooling_fprop2_hw(i8 %ap_core, i8 %ap_part, i8 %ap_parent, i32* %c3_conv_layer_copy.0, i32* %c3_conv_layer_copy.1, i32* %c3_conv_layer_copy.2, [120 x [1024 x double]]* %c3_conv_layer_copy.3.0, [120 x [1024 x double]]* %c3_conv_layer_copy.3.1, [120 x double]* %c3_conv_layer_copy.3.2, [120 x double]* %c3_conv_layer_copy.3.3, i32* %c3_conv_layer_copy.4, i32* %c3_conv_layer_copy.5, i32* %c3_conv_layer_copy.6, [1920 x i3200]* %c3_conv_layer_copy.7, [1024 x double]* %c3_conv_layer_copy.8, i32* %s4_pooling_layer_copy.0, i32* %s4_pooling_layer_copy.1, i32* %s4_pooling_layer_copy.2, [120 x [1024 x double]]* %s4_pooling_layer_copy.3.0, [120 x [1024 x double]]* %s4_pooling_layer_copy.3.1, [120 x double]* %s4_pooling_layer_copy.3.2, [120 x double]* %s4_pooling_layer_copy.3.3, i32* %s4_pooling_layer_copy.4, i32* %s4_pooling_layer_copy.5, i32* %s4_pooling_layer_copy.6, [1920 x i3200]* %s4_pooling_layer_copy.7, [1024 x double]* %s4_pooling_layer_copy.8)
  call void @copy_back(%struct._Layer* %c3_conv_layer, i32* %c3_conv_layer_copy.0, i32* %c3_conv_layer_copy.1, i32* %c3_conv_layer_copy.2, [120 x [1024 x double]]* %c3_conv_layer_copy.3.0, [120 x [1024 x double]]* %c3_conv_layer_copy.3.1, [120 x double]* %c3_conv_layer_copy.3.2, [120 x double]* %c3_conv_layer_copy.3.3, i32* %c3_conv_layer_copy.4, i32* %c3_conv_layer_copy.5, i32* %c3_conv_layer_copy.6, [1920 x i3200]* %c3_conv_layer_copy.7, [1024 x double]* %c3_conv_layer_copy.8, %struct._Layer* %s4_pooling_layer, i32* %s4_pooling_layer_copy.0, i32* %s4_pooling_layer_copy.1, i32* %s4_pooling_layer_copy.2, [120 x [1024 x double]]* %s4_pooling_layer_copy.3.0, [120 x [1024 x double]]* %s4_pooling_layer_copy.3.1, [120 x double]* %s4_pooling_layer_copy.3.2, [120 x double]* %s4_pooling_layer_copy.3.3, i32* %s4_pooling_layer_copy.4, i32* %s4_pooling_layer_copy.5, i32* %s4_pooling_layer_copy.6, [1920 x i3200]* %s4_pooling_layer_copy.7, [1024 x double]* %s4_pooling_layer_copy.8)
...
declare void @apatb_max_pooling_fprop2_hw(i8, i8, i8, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*)
...
declare void @max_pooling_fprop2_hw_stub(i8 zeroext, i8 zeroext, i8 zeroext, %struct._Layer* noalias nocapture nonnull readonly, %struct._Layer* noalias nocapture nonnull)

define void @max_pooling_fprop2_hw_stub_wrapper(i8, i8, i8, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, i32*, i32*, i32*, [1920 x i3200]*, [1024 x double]*) #6 {
entry:
  ...
  call void @max_pooling_fprop2_hw_stub(i8 %0, i8 %1, i8 %2, %struct._Layer* %28, %struct._Layer* %30)
