; ModuleID = '/home/duludulu/Documents/hls/vitis_batch_generate_rtl/prj/fully_connected_fprop_sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_fully_connected_fprop_ir(i8 zeroext %ap_core, i8 zeroext %ap_part, i8 zeroext %ap_parent, %struct._Layer1* noalias nocapture nonnull readonly %c5_conv_layer1, %struct._Layer2* noalias nocapture nonnull readonly %c5_conv_layer2, %struct._Layer1* noalias nocapture nonnull readonly %output_layer1, %struct._Layer2* noalias nocapture nonnull %output_layer2) local_unnamed_addr #0 {
entry:
  ...
  %c5_conv_layer2_copy.0 = bitcast i8* %.0 to [120 x [1024 x double]]*
  %.1 = call i8* @malloc(i64 983040)
  %c5_conv_layer2_copy.1 = bitcast i8* %.1 to [120 x [1024 x double]]*
  %.2 = call i8* @malloc(i64 960)
  %c5_conv_layer2_copy.2 = bitcast i8* %.2 to [120 x double]*
  %.3 = call i8* @malloc(i64 960)
  %c5_conv_layer2_copy.3 = bitcast i8* %.3 to [120 x double]*
  %.4 = call i8* @malloc(i64 384000)
  %c5_conv_layer2_copy.4 = bitcast i8* %.4 to [1920 x [25 x double]]*
  %.5 = call i8* @malloc(i64 384000)
  %c5_conv_layer2_copy.5 = bitcast i8* %.5 to [1920 x [25 x double]]*
  %.6 = call i8* @malloc(i64 8192)
  %c5_conv_layer2_copy.6 = bitcast i8* %.6 to [1024 x double]*
  %output_layer1_copy.0 = alloca i32, align 512
  %output_layer1_copy.1 = alloca i32, align 512
  %output_layer1_copy.2 = alloca i32, align 512
  %output_layer1_copy.3 = alloca i32, align 512
  %output_layer1_copy.4 = alloca i32, align 512
  %output_layer1_copy.5 = alloca i32, align 512
  %.01 = call i8* @malloc(i64 983040)
  %output_layer2_copy.0 = bitcast i8* %.01 to [120 x [1024 x double]]*
  %.12 = call i8* @malloc(i64 983040)
  %output_layer2_copy.1 = bitcast i8* %.12 to [120 x [1024 x double]]*
  %.23 = call i8* @malloc(i64 960)
  %output_layer2_copy.2 = bitcast i8* %.23 to [120 x double]*
  %.34 = call i8* @malloc(i64 960)
  %output_layer2_copy.3 = bitcast i8* %.34 to [120 x double]*
  %.45 = call i8* @malloc(i64 384000)
  %output_layer2_copy.4 = bitcast i8* %.45 to [1920 x [25 x double]]*
  %.56 = call i8* @malloc(i64 384000)
  %output_layer2_copy.5 = bitcast i8* %.56 to [1920 x [25 x double]]*
  %.67 = call i8* @malloc(i64 8192)
  %output_layer2_copy.6 = bitcast i8* %.67 to [1024 x double]*
  call fastcc void @copy_in(%struct._Layer1* nonnull %c5_conv_layer1, i32* nonnull align 512 %c5_conv_layer1_copy.0, i32* nonnull align 512 %c5_conv_layer1_copy.1, i32* nonnull align 512 %c5_conv_layer1_copy.2, i32* nonnull align 512 %c5_conv_layer1_copy.3, i32* nonnull align 512 %c5_conv_layer1_copy.4, i32* nonnull align 512 %c5_conv_layer1_copy.5, %struct._Layer2* nonnull %c5_conv_layer2, [120 x [1024 x double]]* %c5_conv_layer2_copy.0, [120 x [1024 x double]]* %c5_conv_layer2_copy.1, [120 x double]* %c5_conv_layer2_copy.2, [120 x double]* %c5_conv_layer2_copy.3, [1920 x [25 x double]]* %c5_conv_layer2_copy.4, [1920 x [25 x double]]* %c5_conv_layer2_copy.5, [1024 x double]* %c5_conv_layer2_copy.6, %struct._Layer1* nonnull %output_layer1, i32* nonnull align 512 %output_layer1_copy.0, i32* nonnull align 512 %output_layer1_copy.1, i32* nonnull align 512 %output_layer1_copy.2, i32* nonnull align 512 %output_layer1_copy.3, i32* nonnull align 512 %output_layer1_copy.4, i32* nonnull align 512 %output_layer1_copy.5, %struct._Layer2* nonnull %output_layer2, [120 x [1024 x double]]* %output_layer2_copy.0, [120 x [1024 x double]]* %output_layer2_copy.1, [120 x double]* %output_layer2_copy.2, [120 x double]* %output_layer2_copy.3, [1920 x [25 x double]]* %output_layer2_copy.4, [1920 x [25 x double]]* %output_layer2_copy.5, [1024 x double]* %output_layer2_copy.6)
  call void @apatb_fully_connected_fprop_hw(i8 %ap_core, i8 %ap_part, i8 %ap_parent, i32* %c5_conv_layer1_copy.0, i32* %c5_conv_layer1_copy.1, i32* %c5_conv_layer1_copy.2, i32* %c5_conv_layer1_copy.3, i32* %c5_conv_layer1_copy.4, i32* %c5_conv_layer1_copy.5, [120 x [1024 x double]]* %c5_conv_layer2_copy.0, [120 x [1024 x double]]* %c5_conv_layer2_copy.1, [120 x double]* %c5_conv_layer2_copy.2, [120 x double]* %c5_conv_layer2_copy.3, [1920 x [25 x double]]* %c5_conv_layer2_copy.4, [1920 x [25 x double]]* %c5_conv_layer2_copy.5, [1024 x double]* %c5_conv_layer2_copy.6, i32* %output_layer1_copy.0, i32* %output_layer1_copy.1, i32* %output_layer1_copy.2, i32* %output_layer1_copy.3, i32* %output_layer1_copy.4, i32* %output_layer1_copy.5, [120 x [1024 x double]]* %output_layer2_copy.0, [120 x [1024 x double]]* %output_layer2_copy.1, [120 x double]* %output_layer2_copy.2, [120 x double]* %output_layer2_copy.3, [1920 x [25 x double]]* %output_layer2_copy.4, [1920 x [25 x double]]* %output_layer2_copy.5, [1024 x double]* %output_layer2_copy.6)
  call void @copy_back(%struct._Layer1* %c5_conv_layer1, i32* %c5_conv_layer1_copy.0, i32* %c5_conv_layer1_copy.1, i32* %c5_conv_layer1_copy.2, i32* %c5_conv_layer1_copy.3, i32* %c5_conv_layer1_copy.4, i32* %c5_conv_layer1_copy.5, %struct._Layer2* %c5_conv_layer2, [120 x [1024 x double]]* %c5_conv_layer2_copy.0, [120 x [1024 x double]]* %c5_conv_layer2_copy.1, [120 x double]* %c5_conv_layer2_copy.2, [120 x double]* %c5_conv_layer2_copy.3, [1920 x [25 x double]]* %c5_conv_layer2_copy.4, [1920 x [25 x double]]* %c5_conv_layer2_copy.5, [1024 x double]* %c5_conv_layer2_copy.6, %struct._Layer1* %output_layer1, i32* %output_layer1_copy.0, i32* %output_layer1_copy.1, i32* %output_layer1_copy.2, i32* %output_layer1_copy.3, i32* %output_layer1_copy.4, i32* %output_layer1_copy.5, %struct._Layer2* %output_layer2, [120 x [1024 x double]]* %output_layer2_copy.0, [120 x [1024 x double]]* %output_layer2_copy.1, [120 x double]* %output_layer2_copy.2, [120 x double]* %output_layer2_copy.3, [1920 x [25 x double]]* %output_layer2_copy.4, [1920 x [25 x double]]* %output_layer2_copy.5, [1024 x double]* %output_layer2_copy.6)
  call void @free(i8* %.0)
  call void @free(i8* %.1)
  call void @free(i8* %.2)
  call void @free(i8* %.3)
...
declare void @apatb_fully_connected_fprop_hw(i8, i8, i8, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*)
...
declare void @fully_connected_fprop_hw_stub(i8 zeroext, i8 zeroext, i8 zeroext, %struct._Layer1* noalias nocapture nonnull readonly, %struct._Layer2* noalias nocapture nonnull readonly, %struct._Layer1* noalias nocapture nonnull readonly, %struct._Layer2* noalias nocapture nonnull)

define void @fully_connected_fprop_hw_stub_wrapper(i8, i8, i8, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*, i32*, i32*, i32*, i32*, i32*, i32*, [120 x [1024 x double]]*, [120 x [1024 x double]]*, [120 x double]*, [120 x double]*, [1920 x [25 x double]]*, [1920 x [25 x double]]*, [1024 x double]*) #5 {
entry:
  ...
  call void @fully_connected_fprop_hw_stub(i8 %0, i8 %1, i8 %2, %struct._Layer1* %30, %struct._Layer2* %32, %struct._Layer1* %34, %struct._Layer2* %36)
