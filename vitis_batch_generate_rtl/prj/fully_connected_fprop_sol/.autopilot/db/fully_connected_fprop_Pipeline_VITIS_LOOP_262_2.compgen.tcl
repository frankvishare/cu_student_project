...
set name fully_connected_fprop_dmul_64ns_64ns_64_8_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {dmul} IMPL {maxdsp} LATENCY 7 ALLOW_PRAGMA 1
}


set name fully_connected_fprop_mul_11ns_6ns_16_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name c5_conv_layer1_map_count_load \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_c5_conv_layer1_map_count_load \
    op interface \
    ports { c5_conv_layer1_map_count_load { I 32 vector } } \
} "
}
...
set InstName fully_connected_fprop_flow_control_loop_pipe_sequential_init_U
set CompName fully_connected_fprop_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix fully_connected_fprop_ \
}"
} else {
