set moduleName cnn_hls_Pipeline_VITIS_LOOP_105_2
set isTopModule 0
...
set cdfgNum 7
set C_modelName {cnn_hls_Pipeline_VITIS_LOOP_105_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "y_1_cast", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "x", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ y_1_cast sc_in sc_lv 32 signal 0 } 
	{ empty sc_in sc_lv 13 signal 1 } 
	{ x sc_in sc_lv 13 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y_1_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "y_1_cast", "role": "default" }} , 
 	{ "name": "empty", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "empty", "role": "default" }} , 
 	{ "name": "x", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "x", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_13s_13s_13_1_1_U21", "Parent" : "0"},
...
set Spec2ImplPortList { 
	y_1_cast { ap_none {  { y_1_cast in_data 0 32 } } }
	empty { ap_none {  { empty in_data 0 13 } } }
	x { ap_none {  { x in_data 0 13 } } }
