...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convn_valid.autotvin.dat"
	set constFileTvOut       "convn_valid.autotvout.dat"
	set constFileHdlTvIn     "convn_valid.autohdltvin.dat"
	set constFileHdlTvOut    "convn_valid.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
