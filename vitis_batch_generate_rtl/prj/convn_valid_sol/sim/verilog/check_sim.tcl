...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.convn_valid.autotvin_in_data.dat"
         "c.convn_valid.autotvin_in_w.dat"
         "c.convn_valid.autotvin_kernel.dat"
         "c.convn_valid.autotvin_kernel_w.dat"
         "c.convn_valid.autotvin_kernel_h.dat"
         "c.convn_valid.autotvin_out_data.dat"
         "c.convn_valid.autotvin_out_w.dat"
         "c.convn_valid.autotvin_out_h.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.convn_valid.autotvout_out_data.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
