...
if {[file isfile convn_valid.autotvin.dat]} {
	file delete -force convn_valid.autotvin.dat
}

if {[file isfile convn_valid.autotvout.dat]} {
	file delete -force convn_valid.autotvout.dat
}
