...
entity conv_fprop1_conv_fprop1_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conv_fprop1_conv_fprop1_Pipeline_1 is 
...
begin
    ...
    c1_conv_layer2_map_common_address0 <= p_cast13_fu_64_p1(10 - 1 downto 0);
    c1_conv_layer2_map_common_ce0 <= c1_conv_layer2_map_common_ce0_local;

    c1_conv_layer2_map_common_ce0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce)
    begin
    ...
    c1_conv_layer2_map_common_we0 <= c1_conv_layer2_map_common_we0_local;

    c1_conv_layer2_map_common_we0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, ap_ce)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
