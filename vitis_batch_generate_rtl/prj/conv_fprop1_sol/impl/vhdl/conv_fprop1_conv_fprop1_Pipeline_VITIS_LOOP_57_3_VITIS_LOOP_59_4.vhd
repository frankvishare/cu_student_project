...
entity conv_fprop1_conv_fprop1_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conv_fprop1_conv_fprop1_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4 is 
...
attribute shreg_extract : string;
    ...
    signal input_layer2_data_load_reg_446 : STD_LOGIC_VECTOR (63 downto 0);
    signal c1_conv_layer2_W_load_reg_456 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal input_layer2_data_ce0_local : STD_LOGIC;
    signal c1_conv_layer2_W_ce0_local : STD_LOGIC;
    ...
    component conv_fprop1_mac_muladd_16s_16s_16ns_16_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    ama_addmuladd_17ns_17ns_17s_17ns_17_4_1_U5 : component conv_fprop1_ama_addmuladd_17ns_17ns_17s_17ns_17_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 17,
    ...
    mac_muladd_16s_16s_16ns_16_4_1_U6 : component conv_fprop1_mac_muladd_16s_16s_16ns_16_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    c1_conv_layer2_W_address0 <= zext_ln61_1_fu_290_p1(16 - 1 downto 0);
    c1_conv_layer2_W_ce0 <= c1_conv_layer2_W_ce0_local;

    c1_conv_layer2_W_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_ce, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            c1_conv_layer2_W_ce0_local <= ap_const_logic_1;
        else 
            c1_conv_layer2_W_ce0_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    grp_fu_163_p0 <= input_layer2_data_load_reg_446;
    grp_fu_163_p1 <= c1_conv_layer2_W_load_reg_456;
    ...
    icmp_ln57_fu_202_p2 <= "1" when (indvar_flatten_fu_74 = mul_ln105) else "0";
    icmp_ln59_fu_197_p2 <= "1" when (signed(zext_ln59_fu_193_p1) < signed(c1_conv_layer1_kernel_w_load)) else "0";
    input_layer2_data_address0 <= zext_ln61_fu_282_p1(17 - 1 downto 0);
    input_layer2_data_ce0 <= input_layer2_data_ce0_local;

    input_layer2_data_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage6, ap_ce, ap_enable_reg_pp0_iter0_reg, ap_block_pp0_stage6_11001)
    begin
        if (((ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage6_11001) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
            input_layer2_data_ce0_local <= ap_const_logic_1;
        else 
            input_layer2_data_ce0_local <= ap_const_logic_0;
        end if; 
    end process;
