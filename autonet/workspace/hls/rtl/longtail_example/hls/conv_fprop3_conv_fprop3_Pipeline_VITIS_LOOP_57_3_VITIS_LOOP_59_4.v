...
module conv_fprop3_conv_fprop3_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input   ap_ce;
input  [31:0] c5_conv_layer1_kernel_w_load;
input  [61:0] mul_ln173;
input  [16:0] empty_11;
input  [16:0] empty_12;
input  [15:0] empty_13;
input  [16:0] empty;
...
reg   [63:0] s4_pooling_layer2_data_load_reg_446;
reg   [63:0] c5_conv_layer2_W_load_reg_456;
...
reg    c5_conv_layer2_W_ce0_local;
...
conv_fprop3_mac_muladd_16s_16s_16ns_16_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        c5_conv_layer2_W_load_reg_456 <= c5_conv_layer2_W_q0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s4_pooling_layer2_data_load_reg_446 <= s4_pooling_layer2_data_q0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        c5_conv_layer2_W_ce0_local = 1'b1;
    end else begin
        c5_conv_layer2_W_ce0_local = 1'b0;
    end
end
...
assign c5_conv_layer2_W_address0 = zext_ln61_1_fu_290_p1;

assign c5_conv_layer2_W_ce0 = c5_conv_layer2_W_ce0_local;

assign grp_fu_163_p0 = s4_pooling_layer2_data_load_reg_446;

assign grp_fu_163_p1 = c5_conv_layer2_W_load_reg_456;
...
assign icmp_ln57_fu_202_p2 = ((indvar_flatten_fu_74 == mul_ln173) ? 1'b1 : 1'b0);

assign icmp_ln59_fu_197_p2 = (($signed(zext_ln59_fu_193_p1) < $signed(c5_conv_layer1_kernel_w_load)) ? 1'b1 : 1'b0);

assign s4_pooling_layer2_data_address0 = zext_ln61_fu_282_p1;
...
endmodule //conv_fprop3_conv_fprop3_Pipeline_VITIS_LOOP_57_3_VITIS_LOOP_59_4
