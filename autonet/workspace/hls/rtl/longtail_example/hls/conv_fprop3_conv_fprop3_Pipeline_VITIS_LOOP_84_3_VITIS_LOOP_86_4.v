...
module conv_fprop3_conv_fprop3_Pipeline_VITIS_LOOP_84_3_VITIS_LOOP_86_4 (
        ...
        empty,
        zext_ln88_2,
        s4_pooling_layer_data_address0,
        s4_pooling_layer_data_ce0,
        s4_pooling_layer_data_q0,
        mul_ln88,
        c5_conv_layer_W_address0,
        c5_conv_layer_W_ce0,
        c5_conv_layer_W_q0,
        sum_out,
        sum_out_ap_vld,
...
input  [61:0] mul_ln193;
input  [16:0] empty_11;
input  [16:0] empty_12;
input  [15:0] empty_13;
input  [16:0] empty;
input  [16:0] zext_ln88_2;
output  [16:0] s4_pooling_layer_data_address0;
output   s4_pooling_layer_data_ce0;
input  [63:0] s4_pooling_layer_data_q0;
input  [15:0] mul_ln88;
output  [15:0] c5_conv_layer_W_address0;
output   c5_conv_layer_W_ce0;
input  [63:0] c5_conv_layer_W_q0;
output  [63:0] sum_out;
...
reg   [63:0] s4_pooling_layer_data_load_reg_446;
reg   [63:0] c5_conv_layer_W_load_reg_456;
...
reg    s4_pooling_layer_data_ce0_local;
reg    c5_conv_layer_W_ce0_local;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        c5_conv_layer_W_load_reg_456 <= c5_conv_layer_W_q0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s4_pooling_layer_data_load_reg_446 <= s4_pooling_layer_data_q0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        c5_conv_layer_W_ce0_local = 1'b1;
    end else begin
        c5_conv_layer_W_ce0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage6_11001) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        s4_pooling_layer_data_ce0_local = 1'b1;
    end else begin
        s4_pooling_layer_data_ce0_local = 1'b0;
    end
end
...
assign c5_conv_layer_W_address0 = zext_ln88_1_fu_290_p1;

assign c5_conv_layer_W_ce0 = c5_conv_layer_W_ce0_local;

assign grp_fu_163_p0 = s4_pooling_layer_data_load_reg_446;

assign grp_fu_163_p1 = c5_conv_layer_W_load_reg_456;
...
assign icmp_ln84_fu_202_p2 = ((indvar_flatten_fu_74 == mul_ln193) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_197_p2 = (($signed(zext_ln86_fu_193_p1) < $signed(c5_conv_layer_kernel_w_load)) ? 1'b1 : 1'b0);

assign s4_pooling_layer_data_address0 = zext_ln88_fu_282_p1;

assign s4_pooling_layer_data_ce0 = s4_pooling_layer_data_ce0_local;
