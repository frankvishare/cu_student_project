...
#project_dir=~/hls_tools/hls

#specify the hls_tools path
hls_tools_dir=$(dirname $(pwd))
echo "---$hls_tools_dir"
#hls_tools_dir=$(dirname $(pwd))
#hls_tools_dir= $(pwd)
...
autonet_prj_dir=${hls_tools_dir}/autonet/workspace/hls
autonet_export_dir=${hls_tools_dir}/autonet/export/hls
