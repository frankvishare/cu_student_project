...
const int batch_size = 10;//const int 声明了一个常量整数
...
void init_layer(Layer *layer, int prevlayer_map_count, int map_count, int kernel_w, int kernel_h, int map_w, int map_h, bool is_pooling)//Xavier初始化
{
	int mem_size = 0;
